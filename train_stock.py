...
encoder_parameters: HyperParameters = kt.HyperParameters.from_config(saved_config)
attention_parameters: HyperParameters = kt.HyperParameters.from_config(saved_config_att)
...
# read list of sp500 symbols
payload = pd.read_html('https://en.wikipedia.org/wiki/List_of_S%26P_500_companies')

symbols = payload[0]['Symbol'].values.tolist()
